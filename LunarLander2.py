...
class DDQN:
    def __init__(self, num_inputs, num_outputs, hidden_layer_sizes=[80, 80], activation_function="relu", optimizer="adam", loss_function="mean_squared_error", gamma=0.99, experience_buffer_size=80000, min_buffer_size=50, learning_rate=0.001, training_batch_size=64, training_times_per_weight_copy=50):
...
def learn_game():
    ...
    ddqn = DDQN(8, env.action_space.n, hidden_layer_sizes=[64, 64], gamma=0.99, training_times_per_weight_copy=50)
