...
def run_episode_no_train(env, ddqn, random_action_rate, show_video):
    last_state = env.reset()
    ...
    while not done and iterations < 1001:
        ...
        reward2 += 2 * (last_state[1] - next_state[1]) + 2 * (np.abs(last_state[0]) - np.abs(next_state[0]))
        if done:
            print("\t\tReward:", reward_sum, "\tIteration: ", iterations, "\tX:", next_state[0], "\tY:",
                  next_state[1])
        next_state = np.append(next_state, [iterations / 1000])
...
def learn_game():
    ...
    for name, layers in zip(["one 64 layer", "one 128 layer", "two 64 layer"], [[64], [128], [64, 64]]):
        ...
        for i in range(101):
            ...
            reward, steps = run_episode_no_train(env, ddqn, 0, (i % 20 == 0))
            rewards.append(reward)
            steps_to_finish.append(steps)
            test_df.loc[i, name] = reward
            test_steps_df.loc[i, name] = steps
            if i % 20 == 0:
                print("\tTesting: Episode:", i, "\tReward:", reward, "\tSteps:", steps)
    ...
    plt.xlabel("Episode")
    plt.tight_layout()
    plt.savefig(("./Figures/Hidden Layers 100 Experiment"))
    plt.close()
    ...
    plt.xlabel("Episode")
    plt.tight_layout()
    plt.savefig("./Figures/Steps vs Episode 100 Experiment")
    plt.close()

    hidden_layer_df.to_csv("./Data/Hidden Layer 100 Experiment.csv")

    test_df.to_csv("./Data/Hidden Layer 100 Experiment Test.csv")
    test_steps_df.to_csv("./Data/Hidden Layer 100 Experiment Test Steps.csv")

    test_df.plot()
    plt.title("Hidden Layer Test Reward per Episode")
    plt.ylabel("Episode Reward")
    plt.xlabel("Episode")
    plt.tight_layout()
    plt.savefig(("./Figures/Hidden Layers 100 Experiment Test"))
    plt.close()

def random_action_experiment():
    ...
    hidden_layer_df.plot()
    plt.title("RAR Training Reward per Episode")
    plt.ylabel("Episode Reward")
    plt.xlabel("Episode")
    plt.tight_layout()
    plt.savefig(("./Figures/RAR 100 Experiment"))
    plt.close()
    ...
    plt.xlabel("Episode")
    plt.tight_layout()
    plt.savefig("./Figures/RAR Steps vs Episode 100 Experiment")
    plt.close()

    hidden_layer_df.to_csv("./Data/RAR 100 Experiment.csv")

    test_df.to_csv("./Data/RAR 100 Experiment Test.csv")
    test_steps_df.to_csv("./Data/RAR 100 Experiment Test Steps.csv")

    test_df.plot()
    plt.title("RAR Test Reward per Episode")
    plt.ylabel("Episode Reward")
    plt.xlabel("Episode")
    plt.tight_layout()
    plt.savefig(("./Figures/RAR 100 Experiment Test"))
    plt.close()
...
def gamma_experiment():
    ...
    hidden_layer_df.plot()
    plt.title("Gamma Training Reward per Episode")
    plt.ylabel("Episode Reward")
    plt.xlabel("Episode")
    plt.tight_layout()
    plt.savefig(("./Figures/Gamma 100 Experiment"))
    plt.close()
    ...
    plt.xlabel("Episode")
    plt.tight_layout()
    plt.savefig("./Figures/Gamma Steps vs Episode 100 Experiment")
    plt.close()

    hidden_layer_df.to_csv("./Data/Gamma 100 Experiment.csv")

    test_df.to_csv("./Data/Gamma 100 Experiment Test.csv")
    test_steps_df.to_csv("./Data/Gamma 100 Experiment Test Steps.csv")

    test_df.plot()
    plt.title("Gamma Test Reward per Episode")
    plt.ylabel("Episode Reward")
    plt.xlabel("Episode")
    plt.tight_layout()
    plt.savefig(("./Figures/Gamma 100 Experiment Test"))
    plt.close()
